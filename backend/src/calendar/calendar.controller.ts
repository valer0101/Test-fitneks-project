...
async registerForEvent(
  ...
  const userId = req.user.id;
  return this.calendarService.registerForEvent(userId, eventId);
}

@Delete('event/:eventId/register')
...
async unregisterFromEvent(
  ...
  const userId = req.user.id;
  return this.calendarService.unregisterFromEvent(userId, eventId);
}
