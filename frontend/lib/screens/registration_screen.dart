...
// Replace the _register method in your RegistrationScreen with this:
  ...
  Future<void> _register() async {
    ...
    try {
      ...
      if (widget.onSuccessRedirect != null &&
          widget.onSuccessRedirect!.isNotEmpty) {
        ref
            .read(authProvider.notifier)
            .setPostAuthRedirectPath(widget.onSuccessRedirect);
      }
      ...
      body: Stack(
        children: [
          Positioned(
            ...
            child: Container(
              decoration:
                  const BoxDecoration(gradient: AppTheme.fitneksGradient),
            ),
          ),
          SafeArea(
            bottom: false,
