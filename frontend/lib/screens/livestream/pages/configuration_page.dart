            ...
            children: [
              Expanded(
                child: ChoiceChip(
                  ...
                  labelStyle: TextStyle(
                    color: state.visibility == LiveStreamVisibility.PUBLIC ? Colors.white : Colors.black,
                  ),
                ),
              ),
              ...
              Expanded(
                child: ChoiceChip(
                  ...
                  selectedColor: const Color(0xFFFF4D00),
                  labelStyle: TextStyle(
                    color: state.visibility == LiveStreamVisibility.PRIVATE ? Colors.white : Colors.black,
                  ),
                ),
              ),
            ],
