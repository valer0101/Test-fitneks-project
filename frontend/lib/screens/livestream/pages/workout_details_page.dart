...
class WorkoutDetailsPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final hasNoEquipment =
        state.equipmentNeeded.contains(Equipment.NO_EQUIPMENT);
        ...
        children: [
          ...
          Wrap(
            ...
            children: Equipment.values.map((equipment) {
              ...
              final isDisabled =
                  hasNoEquipment && equipment != Equipment.NO_EQUIPMENT;
              ...
              return InkWell(
                ...
                child: Container(
                  decoration: BoxDecoration(
                    color:
                        isSelected ? AppTheme.primaryOrange : Colors.grey[100],
