        ...
        Container(
          ...
          decoration: BoxDecoration(
            gradient: const LinearGradient(
              colors: [Color(0xFFFF4D00), Color(0xFFFF6B35)],
  ...
  return Container(
    ...
    child: Column(
      ...
      children: [
        Row(
          children: [
            const Icon(Icons.info_outline, size: 20, color: Color(0xFFFF4D00)),
            const SizedBox(width: 8),
            const Text(
              'Basic Information',
  ...
  return Container(
    ...
    child: Column(
      ...
      children: [
        Row(
          children: [
            const Icon(Icons.settings, size: 20, color: Color(0xFFFF4D00)),
            const SizedBox(width: 8),
            const Text(
              'Settings',
              style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16),
    ...
    child: Column(
      children: [
        Padding(
          ...
          child: Row(
            children: [
              const Icon(Icons.schedule, size: 20, color: Color(0xFFFF4D00)),
              const SizedBox(width: 8),
              const Text(
                'Schedule',
                style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16),
    ...
    child: Column(
      children: [
        Padding(
          ...
          child: Row(
            children: [
              const Icon(Icons.fitness_center, size: 20, color: Color(0xFFFF4D00)),
              const SizedBox(width: 8),
              const Text(
                'Workout Details',
                style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16),
    ...
    child: Column(
      children: [
        Padding(
          ...
          child: Row(
            children: [
              const Icon(Icons.accessibility_new, size: 20, color: Color(0xFFFF4D00)),
              const SizedBox(width: 8),
              const Text(
