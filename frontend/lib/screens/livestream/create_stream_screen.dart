...
class _CreateStreamScreenState extends ConsumerState<CreateStreamScreen> {
  ...
  Future<void> _loadLivestreamData() async {
    ...
    try {
      ...
      final livestream =
          await repository.getLivestreamByEventId(widget.livestreamId!, token);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(widget.livestreamId != null
            ? 'Edit Live Stream'
            : 'Create Live Stream'),
        leading: IconButton(
        ...
        bottom: PreferredSize(
          ...
          child: LinearProgressIndicator(
            ...
            valueColor:
                const AlwaysStoppedAnimation<Color>(AppTheme.secondaryOrange),
          ),
        ),
      ),
      body: Column(
