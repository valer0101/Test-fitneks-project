        ...
        Positioned(
          ...
          child: SizedBox(
            ...
            child: ElevatedButton.icon(
              ...
              style: ElevatedButton.styleFrom(
                backgroundColor: _hasRequestedToJoin ? Colors.grey : AppTheme.primaryOrange,
                      ...
                      Expanded(
                        child: TextButton(
                          ...
                          child: Text(
                            'Chat',
                            style: TextStyle(
                              color: !_showInfo ? AppTheme.primaryOrange : Colors.grey,
                            ),
                          ),
                        ),
                      ),
...
// ✅ ADD GIFT ANIMATION OVERLAY FOR DESKTOP
  ...
  Widget _buildJoinLiveButton() {
    ...
    Color buttonColor = AppTheme.primaryOrange;
