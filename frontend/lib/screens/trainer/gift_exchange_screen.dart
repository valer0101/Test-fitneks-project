...
import 'package:flutter_stripe/flutter_stripe.dart'
    as stripe; // Add 'as stripe'
import 'package:frontend/services/ruby_purchase_service.dart';
import 'package:frontend/app_theme.dart';
import 'package:frontend/widgets/gradient_elevated_button.dart';
...
class RubyPackage {
  ...
  static const List<RubyPackage> packages = [
    RubyPackage(
        id: 'package_3', rubies: 3, price: 1.99, displayPrice: '\$1.99'),
    RubyPackage(
        id: 'package_9', rubies: 9, price: 4.99, displayPrice: '\$4.99'),
    RubyPackage(
        id: 'package_15', rubies: 15, price: 6.99, displayPrice: '\$6.99'),
    RubyPackage(
        id: 'package_30', rubies: 30, price: 12.99, displayPrice: '\$12.99'),
    RubyPackage(
        id: 'package_60', rubies: 60, price: 24.99, displayPrice: '\$24.99'),
    RubyPackage(
        id: 'package_120', rubies: 120, price: 48.99, displayPrice: '\$48.99'),
    RubyPackage(
        id: 'package_240', rubies: 240, price: 96.99, displayPrice: '\$96.99'),
    RubyPackage(
        id: 'package_480',
        rubies: 480,
        price: 192.99,
          ...
          child: Column(
            ...
            children: [
              ...
              _CounterCard(
                ...
                color: AppTheme.shakesBlueGradient,
                onIncrement: () {
              ...
              _CounterCard(
                ...
                color: AppTheme.fitneksGradient,
                onIncrement: () {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content:
                Text('Successfully initiated withdrawal of \${totalAmount}'),
            backgroundColor: Colors.green,
...
class _CounterCard extends StatelessWidget {
  ...
  final int selected;
  final double value;
  final dynamic color; // Can be Color or Gradient
...
class BoostsTab extends ConsumerWidget {
  ...
  const BoostsTab({super.key, required this.onBuyBoosts});
    ...
    try {
      ...
      if (success && mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
                'Successfully purchased ${_selectedPackage!.rubies} rubies!'),
            backgroundColor: Colors.green,
            duration: const Duration(seconds: 3),
          ),
        );
...
class _BoostPurchaseModalState extends ConsumerState<BoostPurchaseModal>
  ...
  Widget _buildBoostTab({
    ...
    final String boostTitle =
        boostType == 'PROFILE' ? 'Buy Profile Boosts' : 'Buy Notify Boosts';
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
                'Successfully exchanged for $quantity $boostType boost(s)'),
            backgroundColor: Colors.green,
            duration: const Duration(seconds: 3),
          ),
        );
