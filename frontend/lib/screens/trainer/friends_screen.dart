            ...
            onPressed: () async {
              ...
              try {
                ...
                await profilesService
                    .removeFollower(user.username); // ✅ Use username, not ID
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              try {
                print(
                    '🔍 UNFOLLOW: user.id=${user.id}, user.username=${user.username}'); // ✅ ADD THIS

                final profilesService = ref.read(profilesServiceProvider);
                print(
                    '🔍 Calling profilesService.unfollowUser(${user.username})'); // ✅ ADD THIS
