...
class _MyProfileScreenState extends ConsumerState<MyProfileScreen> 
  ...
  List<String> _selectedMuscleGroups = ['arms', 'chest'];
  ...
  void _showRubyPurchaseModal() {
    ...
    if (defaultMethod == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Please add a payment method first. Go to Payment settings.'),
  ...
  floatingActionButton: FloatingActionButton.extended(
    onPressed: () {
      ...
      const testStreamId = 'cmip8lr4q00lt8o2kmkqyvt49';  // ← Replace with your actual ID
          ...
          children: [
            ...
            Align(
              ...
              child: SegmentedButton<String>(
                ...
                selected: {_timeframe},
                onSelectionChanged: (val) => setState(() => _timeframe = val.first),
              ),
            ),
          ],
        ),
...
Widget _buildCompletedList(String title, List<dynamic> items, Color badgeColor) {
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Wrap(
              spacing: 10,
              children: event.equipment.map((eq) => 
                Chip(label: Text(eq))
              ).toList(),
            ),
            const SizedBox(height: 20),
            ...
            const Text('Points Earned:', style: TextStyle(fontWeight: FontWeight.bold)),
            const SizedBox(height: 10),
            ...(event.pointsEarned?.entries.where((e) => e.key != 'total').map((e) =>
              Padding(
                padding: const EdgeInsets.only(bottom: 5),
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
            ...
            Row(
              ...
              children: [
                ...
                Text('${event.pointsEarned?['total'] ?? 0} pts',
                  style: const TextStyle(
                    fontSize: 18,
                    fontWeight: FontWeight.bold,
                    color: Color(0xFFFF6B00),
