// lib/screens/learner/learner_dashboard_shell.dart
...
class LearnerDashboardShell extends ConsumerStatefulWidget {
  final Widget child;
  ...
  @override
  ConsumerState<LearnerDashboardShell> createState() =>
      _LearnerDashboardShellState();
}

class _LearnerDashboardShellState extends ConsumerState<LearnerDashboardShell> {
  ...
  final List<NavigationItem> _navigationItems = [
    ...
    NavigationItem(
      ...
      label: 'Gift Exchange',
      route: '/learner-dashboard/gift-exchange',
    ),
    NavigationItem(
      icon: Icons.calendar_today,
      label: 'Calendar',
      route: '/learner-dashboard/calendar',
    ),
    NavigationItem(
      icon: Icons.people,
      label: 'Friends',
      route: '/learner-dashboard/friends',
    ),
    NavigationItem(
      icon: Icons.payment,
      label: 'Payment',
      route: '/learner-dashboard/payment',
    ),
    NavigationItem(
      icon: Icons.settings,
      label: 'Settings',
      route: '/learner-dashboard/settings',
    ),
    NavigationItem(
      icon: Icons.help_outline,
      label: 'Help & Support',
      route: '/learner-dashboard/support',
    ),
  ];
      ...
      leading: isDesktop
          ? Padding(
              ...
              child: Image.asset(
                ...
                errorBuilder: (c, e, s) => const Icon(Icons.fitness_center, color: Colors.white),
              ),
            )
          : IconButton(
              icon: Consumer(
                builder: (context, ref, child) {
                  ...
                  return profileAsync.when(
                    ...
                    error: (e, s) => const CircleAvatar(radius: 16, child: Icon(Icons.person)),
                  );
                },
              ),
              onPressed: () {
        ...
        if (isDesktop) ...[
          ...
          PopupMenuButton<String>(
            ...
            onSelected: (value) {
              switch (value) {
                case 'settings':
                  context.go('/learner-dashboard/settings');
                  break;
                case 'support':
                  context.go('/learner-dashboard/support');
                  break;
                case 'feedback':
                  context.go('/learner-dashboard/feedback');
                  break;
                case 'logout':
            ...
            itemBuilder: (context) => [
              ...
              const PopupMenuItem(value: 'support', child: Text('Help & Support')),
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return ListTile(
                  leading: Icon(
                    item.icon,
                    color: isSelected ? const Color(0xFFFF6B00) : Colors.grey[700],
                  ),
                  title: Text(
                    item.label,
                    style: TextStyle(
