...
class _PaymentScreenState extends ConsumerState<PaymentScreen> {
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: paymentState.paymentMethods.isNotEmpty
                      ? _showRubyPurchaseModal
                      : null,
  ...
  Widget _buildPaymentMethodCard(PaymentMethod method) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: method.isDefault ? const Color(0xFFFF6B00).withOpacity(0.05) : Colors.grey[50],
        borderRadius: BorderRadius.circular(8),
        border: Border.all(
          color: method.isDefault ? const Color(0xFFFF6B00) : Colors.grey[300]!,
      ...
      child: Row(
        children: [
          Container(
            ...
            child: const Center(
              child: Icon(Icons.diamond, color: Color(0xFFFF6B00), size: 24),
            ),
          ),
