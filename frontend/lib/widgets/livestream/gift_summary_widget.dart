...
final giftData = ref.watch(giftDataProvider(livestreamId));
  ...
  return Row(
    ...
    children: [
      ...
      const SizedBox(width: 4),
      _buildGiftBadge(Icons.bakery_dining, giftData.proteinBarCount, const Color(0xFFFF4D00)),
      const SizedBox(width: 4),
      _buildGiftBadge(Icons.coffee, giftData.proteinPowderCount, Colors.orange),
    ],
  );
}
