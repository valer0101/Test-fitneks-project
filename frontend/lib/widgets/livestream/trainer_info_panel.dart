...
Widget build(BuildContext context, WidgetRef ref) {
  ...
  return Container(
    ...
    padding: const EdgeInsets.only(right: 16, top: 16, bottom: 16),  // ✅ No left padding
      child: Column(
    ...
    child: Column(
      children: [
        ...
        Row(
          ...
          children: [
            const Icon(Icons.people, size: 16, color: Color(0xFFA9A9A9)),
            const SizedBox(width: 4),
            Text(
              '${trainer['subscriberCount'] ?? 0} subscribers',
              style: const TextStyle(color: Color(0xFFA9A9A9), fontSize: 14),
            ),
          ],
        ),
        const SizedBox(height: 16),
...
Widget _buildWorkoutStyleSection(BuildContext context, dynamic livestream) {
  ...
  return Container(
    ...
    child: Column(
      ...
      children: [
        ...
        const SizedBox(height: 12),
        Container(
  padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 8),  // ✅ Changed from 16, 12
  decoration: BoxDecoration(
  ...
  child: Row(
    ...
    children: [
      ...
      const SizedBox(width: 6),  // ✅ Changed from 12
      Text(
            ...
            return GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(8),
                  border: Border.all(
                    color: isToday ? const Color(0xFFFF4D00) : const Color(0xFFFF4D00).withOpacity(0.3),
                    width: isToday ? 2 : 1,
                  ),
                ),
                child: Column(
