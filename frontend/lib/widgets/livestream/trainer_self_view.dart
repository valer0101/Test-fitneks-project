            ...
            children: [
              ...
              _buildControlButton(
                ...
                onPressed: () => ref
                    ...
                    .enableMicrophone(!roomState.isMicEnabled),
                backgroundColor:
                    roomState.isMicEnabled ? Colors.white24 : Colors.red,
              ),
              ...
              _buildControlButton(
                ...
                onPressed: () => ref
                    .read(roomProvider.notifier)
                    .enableCamera(!roomState.isCameraEnabled),
                backgroundColor:
                    roomState.isCameraEnabled ? Colors.white24 : Colors.red,
              ),
            ],
          ),
        ),
