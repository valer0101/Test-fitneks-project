...
class GiftBalanceSummary extends ConsumerWidget {
  ...
  Widget _buildGiftCards(
      BuildContext context, WidgetRef ref, GiftExchangeBalances balances) {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    OutlinedButton(
                      onPressed: () {
                        ref.read(selectedGiftProvider.notifier).state =
                            giftType;
                        ref.read(showPurchasePanelProvider.notifier).state =
                            true;
                        ref.read(quantityProvider.notifier).state = 0;
                      },
                      style: OutlinedButton.styleFrom(
