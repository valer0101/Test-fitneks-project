...
import 'package:frontend/screens/trainer/gift_exchange_screen.dart'
    as trainer_gift;
...
final routerProvider = Provider<GoRouter>((ref) {
  return GoRouter(
    ...
    redirect: (BuildContext context, GoRouterState state) {
      ...
      print(
          'Router Debug - Path: $currentPath, User: ${user?.email}, Loading: $isLoading, Onboarding: ${user?.onboardingCompleted}');
      ...
      final isPublicRoute =
          publicRoutes.any((route) => currentPath.startsWith(route));
      ...
      if (!onboardingComplete) {
        ...
        const trainerOnboarding = '/trainer-onboarding';
        const learnerOnboarding = '/learner-onboarding';
        final targetOnboarding =
            userRole == 'Trainer' ? trainerOnboarding : learnerOnboarding;
      ...
      if ((isPublicRoute ||
        ...
        final dashboard =
            userRole == 'Trainer' ? '/trainer-dashboard' : '/learner-dashboard';
          ...
          GoRoute(
            ...
            builder: (context, state) {
              ...
              return CreateStreamScreen(
                  livestreamId: streamId); // ✅ Pass ID for editing
            },
          ),
        ],
      ),
      ...
      ShellRoute(
        ...
        routes: [
          ...
          GoRoute(
            ...
            builder: (context, state) =>
                const learner_calendar.CalendarScreen(),
          ),
          GoRoute(
